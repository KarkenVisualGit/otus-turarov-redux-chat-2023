...
describe('action creators', () => {
    ...
    it('should create an action to receive messages', () => {
        const messages = [{ id: '1', nickname: 'User', message: 'Test', date: new Date() }];
        const expectedAction = {
    ...
    it('should create an action to send a message', () => {
        const message = { id: '2', nickname: 'User2', message: 'Hello', date: new Date() };
        const expectedAction = {
            type: SEND_MESSAGE,
            payload: message,
        };
    ...
    it('should create an action when a message is sent', () => {
        const message = { id: '3', nickname: 'User3', message: 'Hi there', date: new Date() };
        const expectedAction = {
            type: MESSAGE_SENT,
            payload: message,
        };
    ...
    it('should create an action to receive a new message', () => {
        const newMessage = { id: '4', nickname: 'User4', message: 'Good day', date: new Date() };
        const expectedAction = {
