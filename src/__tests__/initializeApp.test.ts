import { initializeApp, renderedMessageIds } from '../initializeApp';
...
describe('initializeApp', () => {
    ...
    `;
        ...
        emojiPickerButton = document.getElementById('emoji-picker-button') as HTMLElement;
    ...
    it('should set up event handlers', () => {
        expect(logoutButton.addEventListener).toHaveBeenCalledWith('click', handleLogout);
        expect(emojiPickerButton.addEventListener).toHaveBeenCalledWith('click', expect.any(Function));
        expect(sendForm.addEventListener).toHaveBeenCalledWith('submit',  expect.any(Function));
